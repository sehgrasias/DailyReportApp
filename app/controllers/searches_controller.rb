class SearchesController < ApplicationController
  ...
  def create
    ...
    respond_to do |format|
      if @search.save
        ...
        client.chat_postMessage(channel: '#frantest', text: "Got #{@search.candidates} candidates for #{@search.title}", as_user: true)
        else
  ...
  private
    ...
    def search_params
      params.require(:search).permit(:title, :candidates)
    end
end
