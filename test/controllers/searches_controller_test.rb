...
class SearchesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create search" do
    assert_difference("Search.count") do
      post searches_url, params: { search: { candidates: @search.candidates, title: @search.title } }
    end
  ...
  test "should update search" do
    patch search_url(@search), params: { search: { candidates: @search.candidates, title: @search.title } }
